      ...
      {!showQR && (
        <View style={styles.introCard}>
          <Text style={styles.introTitle}>
            Generate a <Text style={{ color: '#2d5be3', fontWeight: 'bold' }}>QR Code</Text> to pay for a purchase or request money.
          </Text>
          <View style={styles.introOption}>
            <MaterialCommunityIcons name="qrcode-scan" size={32} color="#2d5be3" />
          ...
          <View style={styles.introOption}>
            <MaterialCommunityIcons name="earth" size={32} color="#2d5be3" />
            <View style={{ flex: 1, marginLeft: 12 }}>
      ...
      {showQR && (
        <View style={styles.qrCard}>
          ...
          <View style={styles.userInfoRow}>
            ...
            <TouchableOpacity>
              <Ionicons name="pencil" size={18} color="#2d5be3" />
            </TouchableOpacity>
          </View>
          ...
          {amount ? (
            <Text style={[styles.userInfo, { color: '#2d5be3', fontWeight: 'bold', fontSize: 18 }]}>₱{amount}</Text>
          ) : null}
        ...
        <View style={{
          ...
          <View style={{
            ...
            <TouchableOpacity
              ...
              onPress={() => setAmountModal(false)}
            >
              <Text style={{ color: '#2d5be3', fontWeight: 'bold' }}>Cancel</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
